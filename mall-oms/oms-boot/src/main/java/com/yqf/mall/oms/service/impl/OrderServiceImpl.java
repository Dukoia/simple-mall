...
import com.yqf.common.enums.BusinessTypeEnum;
...
import com.yqf.mall.oms.enums.OrderStatusEnum;
import com.yqf.mall.oms.enums.OrderTypeEnum;
import com.yqf.mall.oms.enums.PayTypeEnum;
import com.yqf.mall.oms.mapper.OrderMapper;
...
import com.yqf.mall.ums.api.MemberAddressFeignClient;
...
import com.yqf.redis.component.BusinessNoGenerator;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OmsOrder> implements IOrderService {
    ...
    public OrderSubmitVO submit(OrderSubmitDTO submitDTO) {
        ...
        Long result = this.redisTemplate.execute(redisScript, Collections.singletonList(OmsConstants.ORDER_TOKEN_PREFIX + orderToken), orderToken);
